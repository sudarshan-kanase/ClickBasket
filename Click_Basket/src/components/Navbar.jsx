  ...
  return (
    <nav className="bg-white shadow-md sticky top-0 z-50 px-6 sm:px-10 py-5">
      <div className="max-w-7xl mx-auto flex flex-wrap items-center justify-between gap-6">
        ...
        {/* Navigation Icons */}
        <div className="flex items-center gap-6 text-gray-800 px-2 relative">

          {/* Home */}
          <a href="/HomePage" className="flex flex-col items-center text-sm sm:text-base hover:text-blue-600 transition duration-200">
            <img src="/icons/home.png" alt="Home" className="w-8 h-8 sm:w-10 sm:h-10 mb-1" />
            <span className="hidden sm:inline">Home</span>
          </a>

          {/* Profile */}
          <a href="/admin-profile" className="flex flex-col items-center text-sm sm:text-base hover:text-blue-600 transition duration-200">
            <img src="/icons/profile.png" alt="Profile" className="w-8 h-8 sm:w-10 sm:h-10 mb-1" />
            <span className="hidden sm:inline">Profile</span>
          </a>

          {/* Help */}
          <a href="/ContactPage" className="flex flex-col items-center text-sm sm:text-base hover:text-blue-600 transition duration-200">
          ...
          <button
            ...
            className="relative flex flex-col items-center text-sm sm:text-base hover:text-blue-600 transition duration-200"
          >
